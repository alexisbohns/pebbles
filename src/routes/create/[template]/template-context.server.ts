...
export type LookupRecord = { id: string; label: string; valence?: number | null };
...
export type TemplateContext = {
	config: (typeof templates)[number];
	templateItems: RawTemplateItem[];
	emotions: LookupRecord[];
	associations: LookupRecord[];
